...
const PricingPage = () => {
  ...
  return (
    <div>
      {/* Hero Section */}
      <section className="pt-20 pb-16 md:pt-28 md:pb-20 bg-gradient-to-br from-accurate-blue-100 via-white to-accurate-yellow-50">
      ...
      <section className="py-12 bg-white">
        <div className="container">
          <div className="flex justify-center items-center space-x-4 mb-12">
            <span className={`text-lg ${billingCycle === "monthly" ? "font-semibold text-accurate-blue-600" : "text-gray-600"}`}>
              Monthly Billing
            </span>
            <button 
            ...
            <span className={`text-lg ${billingCycle === "yearly" ? "font-semibold text-accurate-blue-600" : "text-gray-600"}`}>
              Yearly Billing <span className="text-sm bg-accurate-yellow-100 text-accurate-blue-700 font-medium px-2 py-0.5 rounded-full">Save 20%</span>
            </span>
          </div>
            ...
            {pricingPlans.map(plan => (
              <div 
                ...
                className={`relative rounded-xl border ${
                  plan.mostPopular 
                    ? "border-accurate-blue-500 shadow-xl ring-1 ring-accurate-blue-200" 
                    : "border-gray-200 hover:border-accurate-blue-300 hover:shadow-lg"
                } bg-white p-6 animate-on-scroll transition-all duration-300`}
              >
                {plan.mostPopular && (
                  <div className="absolute -top-4 left-0 right-0 mx-auto w-32 rounded-full bg-gradient-to-r from-accurate-yellow-400 to-accurate-orange-400 py-1 text-center text-sm font-semibold text-accurate-purple-800 shadow-md">
                    Most Popular
                  </div>
                )}
                <div className="mb-6">
                ...
                <div className="mb-6">
                  <p className="text-4xl font-bold text-accurate-blue-700">
                ...
                <ul className="mb-6 space-y-3">
                  {plan.features.map(feature => (
                    <li key={feature} className="flex items-start">
                      <Check className="h-5 w-5 mr-2 text-accurate-blue-600 flex-shrink-0" />
                      <span>{feature}</span>
                    </li>
                  ))}
                </ul>
                <Button 
                  className={`w-full ${
                    plan.mostPopular 
                      ? "bg-gradient-to-r from-accurate-blue-500 to-accurate-purple-700 shadow-md hover:shadow-lg" 
                      : ""
                  }`} 
      ...
      {/* Comparison Section */}
      <section className="py-20 bg-gradient-to-br from-accurate-blue-50 to-white">
        <div className="container">
          <SectionHeading 
            ...
            <table className="branded-table">
              <thead>
                <tr>
                  ...
                  <th className="p-4 text-center font-bold bg-accurate-blue-100">Professional</th>
              ...
              <tbody>
                <tr>
                  ...
                  <td className="p-4 text-center bg-accurate-blue-50">10</td>
                ...
                <tr>
                  ...
                  <td className="p-4 text-center bg-accurate-blue-50">Advanced</td>
                ...
                <tr>
                  ...
                  <td className="p-4 text-center bg-accurate-blue-50">Multiple</td>
                  <td className="p-4 text-center">All</td>
                </tr>
                <tr>
                  <td className="p-4 font-medium">Support</td>
                  <td className="p-4 text-center">Email</td>
                  <td className="p-4 text-center bg-accurate-blue-50">Email & Phone</td>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="space-y-6">
              <div className="bg-white rounded-lg border border-accurate-blue-100 p-6 animate-on-scroll shadow-sm hover:shadow-md transition-all hover:border-accurate-blue-200">
                <h3 className="text-lg font-bold mb-2 text-accurate-blue-800">Can I change plans later?</h3>
              ...
              <div className="bg-white rounded-lg border border-accurate-blue-100 p-6 animate-on-scroll shadow-sm hover:shadow-md transition-all hover:border-accurate-blue-200">
                <h3 className="text-lg font-bold mb-2 text-accurate-blue-800">Is there a free trial?</h3>
                <p className="text-gray-600">
                  Yes, we offer a 14-day free trial for all plans. No credit card required to get started.
                </p>
              </div>
              <div className="bg-white rounded-lg border border-accurate-blue-100 p-6 animate-on-scroll shadow-sm hover:shadow-md transition-all hover:border-accurate-blue-200">
                <h3 className="text-lg font-bold mb-2 text-accurate-blue-800">What payment methods do you accept?</h3>
                <p className="text-gray-600">
                  We accept major credit cards, bank transfers, and mobile money payments including M-Pesa.
                </p>
              </div>
              <div className="bg-white rounded-lg border border-accurate-blue-100 p-6 animate-on-scroll shadow-sm hover:shadow-md transition-all hover:border-accurate-blue-200">
                <h3 className="text-lg font-bold mb-2 text-accurate-blue-800">Do you offer custom plans?</h3>
                <p className="text-gray-600">
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-accurate-yellow-400 to-accurate-orange-400 text-accurate-purple-800">
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Need Help Choosing the Right Plan?</h2>
            <p className="text-xl text-accurate-purple-800/90 mb-8">
              Our team is ready to help you select the best option for your business needs.
            </p>
            <div className="flex flex-wrap gap-4 justify-center">
              <Button size="lg" variant="secondary" className="bg-accurate-blue-500 hover:bg-accurate-blue-600" asChild>
                <Link to="/contact">Contact Sales</Link>
              </Button>
              <Button size="lg" variant="outline" className="border-accurate-blue-500 text-accurate-blue-500 hover:bg-accurate-blue-50/30" asChild>
