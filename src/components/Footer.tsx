        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-accurate-purple-600 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link to="/about" className="text-gray-600 hover:text-accurate-purple-600 transition-colors">About Us</Link></li>
              <li><Link to="/contact" className="text-gray-600 hover:text-accurate-purple-600 transition-colors">Contact</Link></li>
              <li><Link to="/testimonials" className="text-gray-600 hover:text-accurate-purple-600 transition-colors">Testimonials</Link></li>
              <li><a href="#" className="text-gray-600 hover:text-accurate-purple-600 transition-colors">Partners</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex flex-wrap justify-center gap-4 text-sm">
              <a href="#" className="text-gray-500 hover:text-accurate-purple-600 transition-colors">Terms of Service</a>
              <a href="#" className="text-gray-500 hover:text-accurate-purple-600 transition-colors">Privacy Policy</a>
              <a href="#" className="text-gray-500 hover:text-accurate-purple-600 transition-colors">Cookie Policy</a>
            </div>
          </div>
        </div>
      </div>
